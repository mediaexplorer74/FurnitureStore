...
namespace FurnitureStore
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        private void TapGestureRecognizer_Tapped(object sender, EventArgs e)
        {
            ...
            ItemsViewModel selectedItem = MyCarousel.CurrentItem as ItemsViewModel;

            if (selectedItem == null)
            {
                Debug.WriteLine("Can't get current item");
            }
            else
            {
                ...
                Debug.WriteLine("ACTION: TapGestureRecognizer_Tapped");
