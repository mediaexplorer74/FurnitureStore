    ...
    public static class DataStore
    {
        static DataStore()
        {
            ...
            Items.Add(new Item()
            {
                ...
                {
                    new Variation () { ColorHex="#0000FF", Image="mammut_blue.png" },
                    new Variation () { ColorHex="#ffC0CB", Image="mammut_pink.png" },
                    new Variation () { ColorHex="#FF0000", Image="mammut_red.png" },
                }
            });
            ...
            Items.Add(new Item()
            {
                ...
                Variations = new List<Variation>()
                {
                    new Variation () { ColorHex="#FF0000", Image="poang_red.png" },
                    new Variation () { ColorHex="#E1C699", Image="poang_beige.png" },
                    new Variation () { ColorHex="#36454F", Image="poang_charcoal.png" },
                    new Variation () { ColorHex="#00FF00", Image="poang_green.png" },
                }
            });
